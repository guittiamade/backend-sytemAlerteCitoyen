...
<div class="max-w-3xl bg-white rounded-xl border border-slate-200 shadow-sm p-6">
  ...
  <form method="post" action="{{ route('admin.users.update',$user) }}" class="grid md:grid-cols-2 gap-4">
    ...
    <div>
      ...
      <input type="email" name="email" value="{{ old('email',$user->email) }}" class="w-full px-3 py-2 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500">
    ...
    <div>
      ...
      <input type="tel" name="tel" value="{{ old('tel',$user->tel) }}" required class="w-full px-3 py-2 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500">
